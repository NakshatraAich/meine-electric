...
export function WhyIronair() {
  ...
  return (
    <section className="section-spacing bg-white pt-20 md:pt-24">
      <div className="container-padding space-y-36">
        {/* Main Section */}
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-72">
          {/* Left Content */}
          <motion.div
          ...
          {/* Video Section */}
          <div className="flex-1 w-full relative lg:aspect-[4/3] overflow-hidden rounded-sm">
            <video
              src="/vid.mkv"
              ref={videoRef}
              autoPlay
            ...
            >
              {['Box 1', 'Box 2', 'Box 3'].map((text, idx) => (
                <motion.div
                  key={idx}
                  className="border-meine-electric border-2 border-2 aspect-square text-white px-12 py-12 rounded shadow-md flex items-center justify-center"
                  variants={{
...
<div className="flex flex-col items-center mt-10 gap-6 lg:px-20">
